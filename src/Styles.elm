module Styles exposing (button, cardImage, landscapeCardImage, mainDiv, selectDiv, cardsDiv)

import Css exposing (..)
import Html.Styled exposing (Attribute, Html, img, styled, div)
...
selectDiv = styled div [ flex3 (int 1) (int 0) (px 300)]


cardsDiv : List (Attribute msg) -> List (Html msg) -> Html msg
cardsDiv = styled div [ flex3 (int 1) (int 1) (px 500)]
